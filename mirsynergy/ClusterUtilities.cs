...
namespace mirsynergy
{
    ...
    {
        public static double GetWeightsOfInternalEdges(Matrix microRnaMicroRnaSynergyScores, List<int> microRnaIndexes)
        {
        ...
        public static double GetTotalWeightsOfBoundaryEdges(Matrix microRnaMicroRnaSynergyScores, List<int> microRnaIndexes)
        {
        ...
        public static double Density(Cluster cluster, Matrix microRnaMicroRnaSynergyScores)
        {
        ...
        private static double GetTotalWeight(Matrix microRnaMicroRnaSynergyScores, IEnumerable<Tuple<int, int>> allPairs)
        {
